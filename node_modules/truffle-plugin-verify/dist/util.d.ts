...
export declare const abort: (message: string, logger?: Console, code?: number) => void;
export declare const enforce: (condition: any, message: string, logger?: Console, code?: number) => void;
 ...
 */
export declare const getNetwork: (config: TruffleConfig, logger: Logger) => Promise<RetrievedNetworkInfo>;
/**
...
export declare const getRpcSendFunction: (provider?: TruffleProvider) => any | undefined;
export declare const deepCopy: <T>(obj: T) => T;
export declare const getAddressFromStorage: (storage: string) => string;
export declare const getPlatform: (apiUrl: string) => {
    platform: string;
    subPlatform?: string | undefined;
};
export declare const getApiKey: (config: TruffleConfig, apiUrl?: string) => string | undefined;
export declare const getArtifact: (contractName: string, options: Options, logger: Logger) => Artifact;
export declare const extractCompilerVersion: (artifact: Artifact) => string;
export declare const getInputJSON: (artifact: Artifact, options: Options, logger: Logger) => InputJson;
export declare const getLibraries: (artifact: Artifact, options: Options, logger: Logger) => Libraries;
export declare const logObject: (logger: Logger, level: 'debug' | 'info', obj: any, indent: number) => void;
